...
class RequestData(models.Model):
    ...
    continent = models.CharField(max_length=64, blank=True, null=True, default='None')
    continent_cn = models.CharField(max_length=64, blank=True, null=True, default='None')
    country_name = models.CharField(max_length=64, blank=True, null=True, default='None')
    country_name_cn = models.CharField(max_length=64, blank=True, null=True, default='None')
    country_specific_name = models.CharField(max_length=64, blank=True, null=True, default='None')
    country_specific_name_cn = models.CharField(max_length=64, blank=True, null=True, default='None')
    city_name = models.CharField(max_length=64, blank=True, null=True, default='None')
    city_name_cn = models.CharField(max_length=64, blank=True, null=True, default='None')
